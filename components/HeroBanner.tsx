...
const HeroBanner: React.FC = () => {
  return (
    ...
    >
      <title id="hero-title">Đà Nẵng Xanh</title>
      <desc id="hero-desc">Biểu ngữ cho Đà Nẵng Xanh với hình ảnh cây cối và thành phố xanh, với một đường cong gợn sóng ở dưới.</desc>
